...
public class SudokuCell extends TextField
{
  ...
  /**
   * Initializes the following variables: {@link #cellIndex} {@link #parentBlockId}
   * {@link #currentValue} {@link #correctValue} {@link #notes} {@link #parentSudoku}
   * {@link #borderClass} {@link #writingTool} {@link #textListener} Loads the sudoku cell's base
  ...
  private int shiftCellIndexLeft()
  {
    return this.cellIndex
        - (this.parentSudoku.getBlockSize() * (this.parentBlockId % this.parentSudoku.getBlockSize()));
  }
  ...
  {
    return tempIndex - (this.parentSudoku.getBlockSize() * this.parentSudoku.getPuzzleSize()
        * (this.parentBlockId / this.parentSudoku.getBlockSize()));
  }
  ...
  {
    this.removeStyling("correct-cell-occurrence", "incorrect-cell-occurrence", "clicked-sudoku-cell",
        "row-col-block-cell", "hint-cell");
  }
