...
public class ExitApplicationDialog extends Dialog
{
	...
	{
		VBox exitApplicationDialogContentContainer = new VBox();
	...
	{
		Label exitApplicationDialogTitle = new Label("Are you sure you want to exit the application?");
	...
	{
		HBox exitApplicationDialogButtonContainer = new HBox();
