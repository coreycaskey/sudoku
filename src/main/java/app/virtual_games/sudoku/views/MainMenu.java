...
public class MainMenu extends StackPane
{
	...
	{
		VBox mainMenuOuterContainer = new VBox();
	...
	{
		Button exitApplicationDialogButton = new Button();
	...
	{
		Button infoDialogButton = new Button();
	...
	{
		VBox mainMenuInnerContainer = new VBox();
	...
	{
		Label mainMenuTitle = new Label("Do You Sudoku?");
	...
	{
		HBox mainMenuDifficultyContainer = new HBox();
	...
	{
		Label mainMenuDifficultyLabel = new Label("Puzzle Difficulty: ");
	...
	{
		ComboBox<String> mainMenuDifficultyDropdown = new ComboBox<String>(GameController.getPuzzleDifficulties());
